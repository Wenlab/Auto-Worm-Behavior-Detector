...
function label_rearranged = machine_label_test(centerlines_camera, centerlines_lab, idx_beyond_edge)
...
%% label roaming
label_rearranged = label_roaming_test(label_rearranged, centerlines_lab);
