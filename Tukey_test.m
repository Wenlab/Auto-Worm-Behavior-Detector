function [number_of_up_outliers, number_of_down_outliers, mask_up, mask_down, up_limit, down_limit] = Tukey_test(train_feature, IQR_index)
    ...
    down_limit = lower_bound - IQR * IQR_index; % mask is normal, ~mask is outlier
